"use strict";(self.webpackChunk_freenow_wave=self.webpackChunk_freenow_wave||[]).push([[17390],{"./src/components/experimental/TextField/docs/TextField.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{AsTextArea:()=>AsTextArea,Default:()=>Default,Disabled:()=>Disabled,Invalid:()=>Invalid,InvalidWithMessage:()=>InvalidWithMessage,WithActionIcon:()=>WithActionIcon,WithDefaultValue:()=>WithDefaultValue,WithDescription:()=>WithDescription,WithLeadingIcon:()=>WithLeadingIcon,WithMaxLength:()=>WithMaxLength,WithPlaceholder:()=>WithPlaceholder,__namedExportsOrder:()=>__namedExportsOrder,default:()=>TextField_stories});var react=__webpack_require__("./node_modules/react/index.js"),dist=__webpack_require__("./node_modules/@storybook/addon-actions/dist/index.mjs"),TextField=__webpack_require__("./node_modules/react-aria-components/dist/TextField.mjs"),Text=__webpack_require__("./node_modules/react-aria-components/dist/Text.mjs"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),themeGet=__webpack_require__("./src/utils/experimental/themeGet.ts"),cssVariables=__webpack_require__("./src/essentials/experimental/cssVariables.ts"),Text_Text=__webpack_require__("./src/components/experimental/Text/Text.tsx"),VisuallyHidden=__webpack_require__("./src/components/VisuallyHidden/VisuallyHidden.tsx"),Button=__webpack_require__("./node_modules/react-aria-components/dist/Button.mjs"),XCrossCircleIcon=__webpack_require__("./src/icons/actions/XCrossCircleIcon.tsx");const StyledButton=(0,styled_components_browser_esm.Ay)(Button.$)`
    appearance: none;
    background: none;
    border: none;
    display: flex;
...
`,TopLine=styled_components_browser_esm.Ay.div`
    ...
    & > :not(${InnerWrapper}) {
        flex-shrink: 0;
        padding-top: ${(0,themeGet.J)("space.2")};
    }
...
`;function TextField_TextField({label,description,errorMessage,placeholder,leadingIcon,actionIcon,multiline=!1,ariaStrings=defaultAriaStrings,...props}){const[text,setText]=react.useState(props.defaultValue||props.value||""),inputRef=react.useRef(null);return react.createElement(Wrapper,{...props,value:text,onChange:value=>{setText(value),props.onChange?.(value)}},react.createElement(TopLine,null,leadingIcon,react.createElement(InnerWrapper,{$autoResize:multiline,"data-replicated-value":text},react.createElement(Label_Label,{$flying:Boolean(placeholder||text.length>0)},label),multiline?react.createElement(Field_TextArea,{placeholder,ref:inputRef}):react.createElement(Field_Input,{placeholder,ref:inputRef})),actionIcon||(text.length>0?react.createElement(ClearButton,{"aria-controls":inputRef.current?.id,"aria-label":ariaStrings.clearFieldButton,onPress:()=>{inputRef.current.value="",setText("")}}):react.createElement(VisuallyHidden.s,{"aria-live":"polite"},ariaStrings.messageFieldIsCleared))),react.createElement(BottomLine,null,(description||errorMessage)&&react.createElement(Text.E,{slot:description?"description":"errorMessage"},errorMessage||description),Boolean(props.maxLength)&&react.createElement(Counter,null,`${text.length} / ${props.maxLength}`)))}try{TextField_TextField.displayName="TextField",TextField_TextField.__docgenInfo={description:"",displayName:"TextField",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},leadingIcon:{defaultValue:null,description:"",name:"leadingIcon",required:!1,type:{name:"ReactNode"}},actionIcon:{defaultValue:null,description:"",name:"actionIcon",required:!1,type:{name:"ReactNode"}},placeholder:{defaultValue:null,description:"",name:"placeholder",required:!1,type:{name:"string"}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"string"}},errorMessage:{defaultValue:null,description:"",name:"errorMessage",required:!1,type:{name:"string"}},multiline:{defaultValue:{value:"false"},description:"",name:"multiline",required:!1,type:{name:"boolean"}},ariaStrings:{defaultValue:{value:"{\n    clearFieldButton: 'Clear field',\n    messageFieldIsCleared: 'The field is cleared'\n}"},description:"If you project supports multiple languages, it is recommended to pass translated labels to these properties",name:"ariaStrings",required:!1,type:{name:"{ clearFieldButton: string; messageFieldIsCleared: string; }"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/experimental/TextField/TextField.tsx#TextField"]={docgenInfo:TextField_TextField.__docgenInfo,name:"TextField",path:"src/components/experimental/TextField/TextField.tsx#TextField"})}catch(__react_docgen_typescript_loader_error){}var PersonFilledIcon=__webpack_require__("./src/icons/trip/PersonFilledIcon.tsx"),EyeIcon=__webpack_require__("./src/icons/actions/EyeIcon.tsx");const TextField_stories={title:"Experimental/Components/TextField",component:TextField_TextField,args:{label:"Passenger name"},argTypes:{label:{description:"The label of the text field"},maxLength:{description:"The maximum length of the text field (optional)",control:"number"},isDisabled:{control:"boolean"},isInvalid:{control:"boolean"},type:{control:"select",options:["text","password","search","tel"]}}},Default={},WithPlaceholder={args:{placeholder:"Placeholder"}},WithDefaultValue={args:{defaultValue:"Value"}},WithDescription={args:{description:"Helper text"}},WithMaxLength={args:{maxLength:999}},Disabled={args:{isDisabled:!0}},Invalid={args:{isInvalid:!0}},InvalidWithMessage={args:{isInvalid:!0,errorMessage:"Error text"}},WithLeadingIcon={args:{leadingIcon:react.createElement(PersonFilledIcon.A,{color:(0,cssVariables.sR)("on-surface-variant")})}},WithActionIcon={args:{label:"Password",type:"password",actionIcon:react.createElement(EyeIcon.A,{color:(0,cssVariables.sR)("on-surface-variant"),onClick:(0,dist.XI)("Show password")})}},AsTextArea={args:{multiline:!0,label:"Leave us a comment"}},__namedExportsOrder=["Default","WithPlaceholder","WithDefaultValue","WithDescription","WithMaxLength","Disabled","Invalid","InvalidWithMessage","WithLeadingIcon","WithActionIcon","AsTextArea"];Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"{}",...Default.parameters?.docs?.source}}},WithPlaceholder.parameters={...WithPlaceholder.parameters,docs:{...WithPlaceholder.parameters?.docs,source:{originalSource:"{\n  args: {\n    placeholder: 'Placeholder'\n  }\n}",...WithPlaceholder.parameters?.docs?.source}}},WithDefaultValue.parameters={...WithDefaultValue.parameters,docs:{...WithDefaultValue.parameters?.docs,source:{originalSource:"{\n  args: {\n    defaultValue: 'Value'\n  }\n}",...WithDefaultValue.parameters?.docs?.source}}},WithDescription.parameters={...WithDescription.parameters,docs:{...WithDescription.parameters?.docs,source:{originalSource:"{\n  args: {\n    description: 'Helper text'\n  }\n}",...WithDescription.parameters?.docs?.source}}},WithMaxLength.parameters={...WithMaxLength.parameters,docs:{...WithMaxLength.parameters?.docs,source:{originalSource:"{\n  args: {\n    maxLength: 999\n  }\n}",...WithMaxLength.parameters?.docs?.source}}},Disabled.parameters={...Disabled.parameters,docs:{...Disabled.parameters?.docs,source:{originalSource:"{\n  args: {\n    isDisabled: true\n  }\n}",...Disabled.parameters?.docs?.source}}},Invalid.parameters={...Invalid.parameters,docs:{...Invalid.parameters?.docs,source:{originalSource:"{\n  args: {\n    isInvalid: true\n  }\n}",...Invalid.parameters?.docs?.source}}},InvalidWithMessage.parameters={...InvalidWithMessage.parameters,docs:{...InvalidWithMessage.parameters?.docs,source:{originalSource:"{\n  args: {\n    isInvalid: true,\n    errorMessage: 'Error text'\n  }\n}",...InvalidWithMessage.parameters?.docs?.source}}},WithLeadingIcon.parameters={...WithLeadingIcon.parameters,docs:{...WithLeadingIcon.parameters?.docs,source:{originalSource:"{\n  args: {\n    leadingIcon: <PersonFilledIcon color={getSemanticValue('on-surface-variant')} />\n  }\n}",...WithLeadingIcon.parameters?.docs?.source}}},WithActionIcon.parameters={...WithActionIcon.parameters,docs:{...WithActionIcon.parameters?.docs,source:{originalSource:"{\n  args: {\n    label: 'Password',\n    type: 'password',\n    actionIcon: <EyeIcon color={getSemanticValue('on-surface-variant')} onClick={action('Show password')} />\n  }\n}",...WithActionIcon.parameters?.docs?.source}}},AsTextArea.parameters={...AsTextArea.parameters,docs:{...AsTextArea.parameters?.docs,source:{originalSource:"{\n  args: {\n    multiline: true,\n    label: 'Leave us a comment'\n  }\n}",...AsTextArea.parameters?.docs?.source}}}},"./src/components/VisuallyHidden/VisuallyHidden.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{s:()=>VisuallyHidden});const VisuallyHidden=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js").Ay.div`
    ...
    position: absolute;
    white-space: nowrap;
`;try{VisuallyHidden.displayName="VisuallyHidden",VisuallyHidden.__docgenInfo={description:"",displayName:"VisuallyHidden",props:{ref:{defaultValue:null,description:"",name:"ref",required:!1,type:{name:"Ref<HTMLDivElement>"}},theme:{defaultValue:null,description:"",name:"theme",required:!1,type:{name:"any"}},as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"undefined"}},forwardedAs:{defaultValue:null,description:"",name:"forwardedAs",required:!1,type:{name:"undefined"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/VisuallyHidden/VisuallyHidden.tsx#VisuallyHidden"]={docgenInfo:VisuallyHidden.__docgenInfo,name:"VisuallyHidden",path:"src/components/VisuallyHidden/VisuallyHidden.tsx#VisuallyHidden"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/experimental/Text/Text.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{E:()=>Text,U:()=>textStyles});var styled_components__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),styled_system__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/styled-system/dist/index.esm.js"),_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/essentials/experimental/theme.ts");const textStyles={variants:{display:{fontFamily:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fonts.normal,fontSize:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontSizes[4],fontWeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontWeights.bold,lineHeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.lineHeights[4],fontStretch:"50%"},headline:{fontFamily:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fonts.normal,fontSize:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontSizes[3],fontWeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontWeights.bold,lineHeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.lineHeights[3],fontStretch:"50%"},title1:{fontFamily:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fonts.normal,fontSize:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontSizes[2],fontWeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontWeights.semibold,lineHeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.lineHeights[2]},title2:{fontFamily:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fonts.normal,fontSize:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontSizes[1],fontWeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontWeights.medium,lineHeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.lineHeights[1]},body1:{fontFamily:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fonts.normal,fontSize:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontSizes[1],fontWeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontWeights.normal,lineHeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.lineHeights[1]},body2:{fontFamily:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fonts.normal,fontSize:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontSizes[0],fontWeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontWeights.normal,lineHeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.lineHeights[0]},label1:{fontFamily:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fonts.normal,fontSize:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontSizes[1],fontWeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontWeights.medium,lineHeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.lineHeights[1]},label2:{fontFamily:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fonts.normal,fontSize:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontSizes[0],fontWeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.fontWeights.normal,lineHeight:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w.lineHeights[0]}}},variantStyles=(0,styled_system__WEBPACK_IMPORTED_MODULE_0__.Ox)(textStyles),Text=styled_components__WEBPACK_IMPORTED_MODULE_2__.Ay.span.attrs({theme:_essentials_experimental_theme__WEBPACK_IMPORTED_MODULE_1__.w})`
    color: inherit;
    margin: 0;
