...
## [2.0.0](https://github.com/freenowtech/wave/compare/v1.13.0...v2.0.0) (2021-07-29)


### ⚠ BREAKING CHANGES

* remove the deprecated block property for buttons (#147)

### Features

* remove the deprecated block property for buttons ([#147](https://github.com/freenowtech/wave/issues/147)) ([704136b](https://github.com/freenowtech/wave/commit/704136b9edfb9c70ac5822db822afd4032d2eb2a))
