...
<TitleCard title="Wave Design System">
    Welcome to the Design System of FREE NOW. Thanks for stopping by! This is the place where you find the latest components
    and essentials, that enable you to rapidly build your product.
    <br/>
    <br/>
    Is something missing? Feel free to contribute and we are more than happy to support you.
</TitleCard>
