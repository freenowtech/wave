    ...
    <Card className='hero-banner' level={200} mt="50px">
      <Box display='flex' flexDirection='column'>
        ...
        <Box display='flex' mt='24px' alignItems='center'>
          <a href='/?path=/docs/get-started--docs' className='card-link' >
...
<Headline as="h3" mt="80px" mb="30px">
    ...
    <Box display='flex' justifyContent='space-between'>
      <Card level={200} className='card'>
          ...
          <Text as='p' fontSize='14px' secondary>Convey meaning or structure, highlight various information or elements, display different states through our color palette.</Text>

          <a href='/?path=/docs/essentials-colors--docs' className='card-link'>
      ...
      <Card level={200} className='card'>
          ...
          <Text as='p' fontSize='14px' secondary>Demonstrate the continuity of hierarchy, and importance of content on a page with our typography guidelines and styles.</Text>

          <a href='/?path=/docs/components-text--docs' className='card-link'>
            <Button mt='24px' size='small' variant='secondary'>Explore &nbsp; <ArrowRightIcon /></Button>
          </a>
      </Card>
      ...
      <Card level={200} className='card'>
          ...
          <Text as='p' fontSize='14px' secondary>Indicate the hierarchical relation of elements and consistency in layout with the distance of elements using our spacing system.</Text>

          <a href='/?path=/docs/essentials-spaces--docs' className='card-link'>
            <Button mt='24px' size='small' variant='secondary'>Explore &nbsp; <ArrowRightIcon /></Button>
          </a>
      </Card>
