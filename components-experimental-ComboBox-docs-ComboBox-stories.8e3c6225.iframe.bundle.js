"use strict";(self.webpackChunk_freenow_wave=self.webpackChunk_freenow_wave||[]).push([[88486],{"./src/components/experimental/ComboBox/docs/ComboBox.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{AsyncValues:()=>AsyncValues,Default:()=>Default,Disabled:()=>Disabled,FullyControlled:()=>FullyControlled,Invalid:()=>Invalid,WithDescription:()=>WithDescription,WithIcon:()=>WithIcon,__namedExportsOrder:()=>__namedExportsOrder,default:()=>ComboBox_stories});var react=__webpack_require__("./node_modules/react/index.js"),ComboBox=__webpack_require__("./node_modules/react-aria-components/dist/ComboBox.mjs"),FieldError=__webpack_require__("./node_modules/react-aria-components/dist/FieldError.mjs"),SSRProvider=__webpack_require__("./node_modules/@react-aria/ssr/dist/SSRProvider.mjs"),useResizeObserver=__webpack_require__("./node_modules/@react-aria/utils/dist/useResizeObserver.mjs"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),Popover=__webpack_require__("./src/components/experimental/Popover/Popover.tsx"),ListBox=__webpack_require__("./node_modules/react-aria-components/dist/ListBox.mjs"),FakeInput=__webpack_require__("./src/components/experimental/Field/FakeInput.ts"),Label=__webpack_require__("./src/components/experimental/Field/Label.ts"),InnerWrapper=__webpack_require__("./src/components/experimental/Field/InnerWrapper.ts"),Field=__webpack_require__("./src/components/experimental/Field/Field.ts"),Button=__webpack_require__("./src/components/experimental/Field/Button.ts"),Footer=__webpack_require__("./src/components/experimental/Field/Footer.ts"),Wrapper=__webpack_require__("./src/components/experimental/Field/Wrapper.ts"),XCrossCircleIcon=__webpack_require__("./src/icons/actions/XCrossCircleIcon.tsx"),VisuallyHidden=__webpack_require__("./src/components/VisuallyHidden/VisuallyHidden.tsx"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const defaultAriaStrings={clearFieldButton:"Clear field",messageFieldIsCleared:"The field is cleared"},StyledPopover=(0,styled_components_browser_esm.Ay)(Popover.AM)`
    overflow: auto;
`,ComboBoxInput=react.forwardRef((({label,placeholder,leadingIcon,ariaStrings},forwardedRef)=>{const state=react.useContext(ComboBox.Wf),inputRef=react.useRef(null);return(0,jsx_runtime.jsxs)(FakeInput.u,{$isVisuallyFocused:state?.isOpen,ref:forwardedRef,onClick:()=>inputRef.current?.focus(),children:[leadingIcon,(0,jsx_runtime.jsxs)(InnerWrapper.y,{children:[(0,jsx_runtime.jsx)(Label.J,{$flying:Boolean(placeholder||state?.inputValue?.length>0),children:label}),(0,jsx_runtime.jsx)(Field.pd,{placeholder,ref:inputRef})]}),state?.inputValue?.length>0?(0,jsx_runtime.jsx)(Button.$,{slot:null,"aria-label":ariaStrings.clearFieldButton,onPress:()=>{state?.setSelectedKey(null),state?.setInputValue("")},children:(0,jsx_runtime.jsx)(XCrossCircleIcon.A,{})}):(0,jsx_runtime.jsx)(VisuallyHidden.s,{"aria-live":"polite",children:ariaStrings.messageFieldIsCleared})]})}));function ComboBox_ComboBox({label,children,placeholder,leadingIcon,ariaStrings=defaultAriaStrings,errorMessage,description,...props}){const[menuWidth,setMenuWidth]=(0,react.useState)(null),triggerRef=react.useRef(null),isSSR=(0,SSRProvider.wR)(),onResize=react.useCallback((()=>{if(triggerRef.current){const rect=triggerRef.current.getBoundingClientRect();setMenuWidth(`${rect.width}px`)}}),[]);return(0,useResizeObserver.w)({ref:triggerRef,onResize}),(0,jsx_runtime.jsx)(ComboBox.a3,{"aria-label":label,shouldFocusWrap:!0,...props,children:({isInvalid})=>(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsxs)(Wrapper.m,{children:[(0,jsx_runtime.jsx)(ComboBoxInput,{ref:isSSR?null:triggerRef,label,placeholder,leadingIcon,ariaStrings}),(0,jsx_runtime.jsx)(Footer.w,{children:isInvalid?(0,jsx_runtime.jsx)(FieldError.b,{children:errorMessage}):description})]}),(0,jsx_runtime.jsx)(StyledPopover,{triggerRef,style:{"--trigger-width":menuWidth},children:(0,jsx_runtime.jsx)(ListBox.qF,{children})})]})})}ComboBox_ComboBox.displayName="ComboBox";try{ComboBox_ComboBox.displayName="ComboBox",ComboBox_ComboBox.__docgenInfo={description:"",displayName:"ComboBox",props:{placeholder:{defaultValue:null,description:"",name:"placeholder",required:!1,type:{name:"string"}},ariaStrings:{defaultValue:{value:"{\n    clearFieldButton: 'Clear field',\n    messageFieldIsCleared: 'The field is cleared'\n}"},description:"If your project supports multiple languages,\nit is recommended to pass translated labels to these properties",name:"ariaStrings",required:!1,type:{name:"{ clearFieldButton: string; messageFieldIsCleared: string; }"}},label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"string"}},errorMessage:{defaultValue:null,description:"",name:"errorMessage",required:!1,type:{name:"string"}},leadingIcon:{defaultValue:null,description:"",name:"leadingIcon",required:!1,type:{name:"ReactNode"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/experimental/ComboBox/ComboBox.tsx#ComboBox"]={docgenInfo:ComboBox_ComboBox.__docgenInfo,name:"ComboBox",path:"src/components/experimental/ComboBox/ComboBox.tsx#ComboBox"})}catch(__react_docgen_typescript_loader_error){}var ListBox_ListBox=__webpack_require__("./src/components/experimental/ListBox/ListBox.tsx"),DogIcon=__webpack_require__("./src/icons/basic/DogIcon.tsx");const ComboBox_stories={title:"Experimental/Components/ComboBox",component:ComboBox_ComboBox,parameters:{layout:"centered"},decorators:[Story=>(0,jsx_runtime.jsx)("div",{style:{width:"590px"},children:(0,jsx_runtime.jsx)(Story,{})})],args:{label:"Animal",items:[{id:1,name:"Aardvark"},{id:2,name:"Cat"},{id:3,name:"Dog"},{id:4,name:"Kangaroo"},{id:5,name:"Koala"},{id:6,name:"Penguin"},{id:7,name:"Snake"},{id:8,name:"Turtle"},{id:9,name:"Wombat"}],children:item=>(0,jsx_runtime.jsx)(ListBox_ListBox.nh,{children:item.name})}},Default={},WithIcon={args:{leadingIcon:(0,jsx_runtime.jsx)(DogIcon.A,{})}},WithDescription={args:{description:"Enter your favourite animal"}},Disabled={args:{isDisabled:!0}},Invalid={args:{isInvalid:!0,errorMessage:"Error"}},AsyncValues={render:()=>{const[items,setItems]=react.useState([]),[filterText,setFilterText]=react.useState("");return react.useEffect((()=>{let ignore=!1;return async function startFetching(){const res=await fetch(`https://swapi.py4e.com/api/people/?search=${filterText}`),json=await res.json();ignore||setItems(json.results)}(),()=>{ignore=!0}}),[filterText]),(0,jsx_runtime.jsx)(ComboBox_ComboBox,{label:"Star Wars Character",items,inputValue:filterText,onInputChange:setFilterText,children:item=>(0,jsx_runtime.jsx)(ListBox_ListBox.nh,{id:item.name,children:item.name})})}},FullyControlled={render:()=>{const[items,setItems]=react.useState([]),[filterText,setFilterText]=react.useState(""),[key,setKey]=react.useState(null);return react.useEffect((()=>{let ignore=!1;return async function startFetching(){const res=await fetch(`https://swapi.py4e.com/api/people/?search=${filterText}`),json=await res.json();ignore||setItems(json.results)}(),()=>{ignore=!0}}),[filterText]),(0,jsx_runtime.jsx)(ComboBox_ComboBox,{label:"Star Wars Character",items,inputValue:filterText,selectedKey:key,onSelectionChange:newKey=>{setFilterText(newKey),setKey(newKey)},onInputChange:input=>{setFilterText(input),""===input&&setKey(null)},children:item=>(0,jsx_runtime.jsx)(ListBox_ListBox.nh,{id:item.name,children:item.name})})}};Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"{}",...Default.parameters?.docs?.source}}},WithIcon.parameters={...WithIcon.parameters,docs:{...WithIcon.parameters?.docs,source:{originalSource:"{\n  args: {\n    leadingIcon: <DogIcon />\n  }\n}",...WithIcon.parameters?.docs?.source}}},WithDescription.parameters={...WithDescription.parameters,docs:{...WithDescription.parameters?.docs,source:{originalSource:"{\n  args: {\n    description: 'Enter your favourite animal'\n  }\n}",...WithDescription.parameters?.docs?.source}}},Disabled.parameters={...Disabled.parameters,docs:{...Disabled.parameters?.docs,source:{originalSource:"{\n  args: {\n    isDisabled: true\n  }\n}",...Disabled.parameters?.docs?.source}}},Invalid.parameters={...Invalid.parameters,docs:{...Invalid.parameters?.docs,source:{originalSource:"{\n  args: {\n    isInvalid: true,\n    errorMessage: 'Error'\n  }\n}",...Invalid.parameters?.docs?.source}}},AsyncValues.parameters={...AsyncValues.parameters,docs:{...AsyncValues.parameters?.docs,source:{originalSource:"{\n  render: () => {\n    const [items, setItems] = React.useState<Character[]>([]);\n    const [filterText, setFilterText] = React.useState('');\n    React.useEffect(() => {\n      let ignore = false;\n      async function startFetching() {\n        const res = await fetch(`https://swapi.py4e.com/api/people/?search=${filterText}`);\n        const json = await res.json();\n        if (!ignore) {\n          setItems(json.results);\n        }\n      }\n\n      // eslint-disable-next-line no-void\n      void startFetching();\n      return () => {\n        ignore = true;\n      };\n    }, [filterText]);\n    return <ComboBox<Character> label=\"Star Wars Character\" items={items} inputValue={filterText} onInputChange={setFilterText}>\n                {item => <ListBoxItem id={item.name}>{item.name}</ListBoxItem>}\n            </ComboBox>;\n  }\n}",...AsyncValues.parameters?.docs?.source}}},FullyControlled.parameters={...FullyControlled.parameters,docs:{...FullyControlled.parameters?.docs,source:{originalSource:"{\n  render: () => {\n    const [items, setItems] = React.useState<Character[]>([]);\n    const [filterText, setFilterText] = React.useState('');\n    const [key, setKey] = React.useState<string | null>(null);\n    React.useEffect(() => {\n      let ignore = false;\n      async function startFetching() {\n        const res = await fetch(`https://swapi.py4e.com/api/people/?search=${filterText}`);\n        const json = await res.json();\n        if (!ignore) {\n          setItems(json.results);\n        }\n      }\n\n      // eslint-disable-next-line no-void\n      void startFetching();\n      return () => {\n        ignore = true;\n      };\n    }, [filterText]);\n    return <ComboBox label=\"Star Wars Character\" items={items} inputValue={filterText} selectedKey={key} onSelectionChange={newKey => {\n      setFilterText(newKey as string);\n      setKey(newKey as string);\n    }} onInputChange={input => {\n      setFilterText(input);\n      if (input === '') {\n        setKey(null);\n      }\n    }}>\n                {item => <ListBoxItem id={item.name}>{item.name}</ListBoxItem>}\n            </ComboBox>;\n  }\n}",...FullyControlled.parameters?.docs?.source}}};const __namedExportsOrder=["Default","WithIcon","WithDescription","Disabled","Invalid","AsyncValues","FullyControlled"]},"./src/components/VisuallyHidden/VisuallyHidden.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{s:()=>VisuallyHidden});const VisuallyHidden=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js").Ay.div`
    clip: rect(0 0 0 0);
    clip-path: inset(50%);
...
//# sourceMappingURL=components-experimental-ComboBox-docs-ComboBox-stories.8e3c6225.iframe.bundle.js.map