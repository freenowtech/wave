...
<Advice>
    If you need an input to set or ask for a password, use <a href="/components/password">Password component</a> instead.
</Advice>
...
<Playground>
    <ControlledInput variant="boxed" placeholder="user@free-now.com" label="E-Mail Address" />
</Playground>
