import { ArgTypes, Meta, Primary } from '@storybook/addon-docs/blocks';

import { Headline } from '../..';
import { getSemanticValue } from '../../utils/cssVariables';
import { SearchableIconGrid } from './SearchableIconGrid';
import { GuidelineBlock, GuidelineContent, GuidelineImage, GuidelineList } from './GuidelineBlock';
...
<GuidelineBlock>
    ...
    <GuidelineContent>
        ...
        <GuidelineList>
            <Icons.CheckCircleIcon style={{ placeSelf: 'center' }} />
            Default (24px)
            <Icons.LightningIcon size="large" style={{ placeSelf: 'center' }} />
            Service Types (28px)
            <Icons.InfoCircleIcon size="small" style={{ placeSelf: 'center' }} />
            Inline (12px)
        </GuidelineList>
    </GuidelineContent>
</GuidelineBlock>

The content of an icon should remain inside the inner safe zone and should only extend into the padding between
...
<GuidelineBlock>
    ...
    <GuidelineContent>
        <GuidelineList>
            ...
            <Icons.ScooterFilledIcon color={getSemanticValue('foreground-primary')} />
            Active/selected tab bar icons are colored in primary color
        </GuidelineList>
    </GuidelineContent>
</GuidelineBlock>
