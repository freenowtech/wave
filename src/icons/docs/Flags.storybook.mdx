import { Primary, Meta, ArgsTable, IconGallery, IconItem } from '@storybook/blocks';

import { Flag } from '../Flag';
import FlagStories from './Flags.stories';
...
<ArgsTable story="Flags" exclude={['theme', 'as', 'forwardedAs']} />
