...
const LegalBannerSolidIcon: React.FC<Props> = ({ size = 'medium', ...props }: IconProps) => {
...
LegalBannerSolidIcon.defaultProps = {
    color: Colors.AUTHENTIC_BLUE_900
};
export default LegalBannerSolidIcon;
