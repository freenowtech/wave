...
const Fuel100Icon: React.FC<Props> = ({ size = 'medium', color = getSemanticValue('foreground-primary'), ...rest }) => {
        ...
        <svg {...props} width={sizePx} height={sizePx} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g fillRule="nonzero" fill="none">
                <path
                    ...
                    fill="currentColor"
                />
                <path fill="#069D4F" d="M14.174 6.253h4v10h-4z" />
            </g>
        </svg>
    );
};
export default Fuel100Icon;
